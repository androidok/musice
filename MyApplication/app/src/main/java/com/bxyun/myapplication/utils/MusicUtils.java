 ...
 */
package com.bxyun.myapplication.utils;
...
import com.bxyun.myapplication.info.AlbumInfo;
import com.bxyun.myapplication.info.ArtistInfo;
import com.bxyun.myapplication.info.FolderInfo;
...
//        order.append(")");
    ...
    public static MusicInfo getMusicInfo(Context context, long id) {
        ...
        while (cursor.moveToNext()) {
            ...
            Log.i("MusicInfo", "getMusicInfo: "+ cursor.getInt(cursor
                    .getColumnIndex(Media._ID))+"     "+
                            cursor.getInt(cursor.getColumnIndex(Media.ALBUM_ID))+"     "+
                            cursor.getString(cursor.getColumnIndex(Albums.ALBUM))+"     "+
                            getAlbumArtUri(music.albumId) + "       "+
                            cursor.getInt(cursor.getColumnIndex(Media.DURATION))+"     "+
                            cursor.getString(cursor.getColumnIndex(Media.TITLE))+"     "+
                            cursor.getInt(cursor.getColumnIndex(Media.SIZE))+"       "+
                            cursor.getString(cursor.getColumnIndex(Media.ARTIST))+"     "+
                            cursor.getLong(cursor.getColumnIndex(Media.ARTIST_ID))+"     "+
                            cursor.getString(cursor.getColumnIndex(Media.DATA))+"     "+folderPath
